...
%add_maven_depmap -a xerces:dom3-xml-apis JPP-%{pkg_name}.pom %{pkg_name}.jar
...
%changelog
* Tue Jan 21 2014 Stanislav Ochotnicky <sochotnicky@redhat.com> - 1.4.01-15.2
- Rebuild to fix provides/requires

* Tue Nov 12 2013 Stanislav Ochotnicky <sochotnicky@redhat.com> - 1.4.01-15.1
